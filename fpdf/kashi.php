...
class Kashi
{
    ...
    public function histr ($x, $bins=false) 
    {
        if ($bins === false) {
            $bins = ceil(sqrt(count($x)));
        }
	...
	public function histrcc ($x, $bins=false) 
    {
        if ($bins === false) {
            $bins = ceil(sqrt(count($x)));
        }
	...
	public function histb ($x, $bins=false) 
    {
        if ($bins === false) {
            $bins = ceil(sqrt(count($x)));
        }
	 ...
	 public function histr10 ($x, $bins=false) 
    {
        if ($bins === false) {
            $bins = ceil(sqrt(count($x)));
        }
	 ...
	 public function histb10 ($x, $bins=false) 
    {
        if ($bins === false) {
            $bins = ceil(sqrt(count($x)));
        }
