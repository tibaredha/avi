...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo 'Relevé des users '; echo '&nbsp;';		
	echo'</th>';
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th id="nomprenom" >login</th>';
	echo'<th id="nomprenom">password</th>';
	echo'<th id="filsde">Unité</th>';
	echo'<th >Update</th>';
	echo'<th >Delete</th>';
	echo'</tr>';
		...
		{ 
			...
			echo '<td align="left" ><b>'.$value['login'].'<b></td>';
			
			echo '<td align="center" >'.$value['password'].'</td>'; 
			...
			echo '<td align="center"  ><a target="_blank" title="editer"    href="'.URL.$ctrl.'/editusers/'.$value['id'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center"  ><a class="delete" title="supprimer"  href="'.URL.$ctrl.'/deleteusers/'.$value['id'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
		...
		if ($total_count <= 0 )
		{
			...
			header('location: ' . URL .$ctrl.'/nouveauusers/'.$this->userListviewq);
