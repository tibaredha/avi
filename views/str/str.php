...
"submitvalue" => 'Search',
"cb1" => $ctrl,"mb1" => 'nouveaustr',        "tb1" => 'nouveau',"vb1" => '',    "icon1" => 'add.PNG',
...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo 'Relevé des structure '; echo '&nbsp;';		
	echo'</th>';
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th id="nomprenom" >structure FR</th>';
	echo'<th id="nomprenom">structure AR</th>';
	...
	echo'</tr>';
		...
		if ($total_count <= 0 )
		{
			...
			header('location: ' . URL .$ctrl.'/nouveaustr/'.$this->userListviewq);
