<div class="sheader1l"><p id="dashboard"><?php echo "Gérer les certificats de Naissance";?></p></div><div class="sheader1r"><p id="dashboard"><?php html::NAV();?></p></div>
<div class="sheader2l">
...
<?php
		...
		echo'<table>';$colspan=13;
			...
			echo '<td align="left" ><b>'.$value['NOM'].'_'.$value['PRENOM'].' ('.$value['FILSDE'].')'.'<b></td>';
		...
		HTML::graphemois(30,340,'Naissance Par Mois Arret Au  : ','','naissance','DINS','',date("Y"),'','='.Session::get('structure'));
		echo "</div>";
