...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th id="nomprenom" >COMMUNE FR</th>';
	echo'<th id="filsde">NUM</th>';
	echo'<th id="filsde">COMMUNE AR</th>';
	echo'<th id="filsde">WILAYA</th>';
	echo'<th >Update</th>';
	echo'<th >Delete</th>';
	echo'</tr>';
		...
		{ 
			...
			echo '<td align="center" >'.$value['IDCOM'].'</td>'; 
			echo '<td align="right" >'.$value['communear'].'</td>'; 
			echo '<td align="center"  ><a target="_blank" title="wilaya"   href="'.URL.$ctrl.'/comm/'.$value['IDCOM'].'" ><img src="'.URL.'public/images/comm.png"   width="16" height="16" border="0" alt=""   /></a></td>';
		...
		if ($total_count <= 0 )
		{
			...
			header('location: ' . URL .$ctrl.'/nouveaucom/'.$this->userListviewq);
