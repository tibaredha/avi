...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th id="nomprenom" >WILAYA FR</th>';
	echo'<th id="filsde">NUM</th>';
	echo'<th id="filsde">WILAYA AR</th>';
	echo'<th id="filsde">COMMUNE</th>';
	echo'<th >Update</th>';
	echo'<th >Delete</th>';
	echo'</tr>';
		...
		{ 
			...
			echo '<td align="center" >'.$value['IDWIL'].'</td>'; 
			echo '<td align="right" >'.$value['WILAYASAR'].'</td>'; 
			echo '<td align="center"  ><a target="_blank" title="Commune"   href="'.URL.$ctrl.'/comm/'.$value['IDWIL'].'" ><img src="'.URL.'public/images/comm.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center"  ><a target="_blank" title="editer"    href="'.URL.$ctrl.'/editwil/'.$value['IDWIL'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center"  ><a class="delete" title="supprimer"  href="'.URL.$ctrl.'/deletewil/'.$value['IDWIL'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
		...
		if ($total_count <= 0 )
		{
			...
			header('location: ' . URL .$ctrl.'/nouveauwil/'.$this->userListviewq);
