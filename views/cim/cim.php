...
"c"   => $ctrl,
"m"   => $mdl,
"combo"   => array("id"=>'row_id',"diag_nom" =>'diag_nom'),
"submitvalue" => 'Search',
"cb1" => $ctrl,"mb1" => 'nouveaucim',        "tb1" => 'nouveau',"vb1" => '',    "icon1" => 'add.PNG',
...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo'</tr>';
		...
		{ 
			...
			echo '<td align="center"  ><a target="_blank" title="editer"    href="'.URL.$ctrl.'/editwil/'.$value['row_id'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center"  ><a class="delete" title="supprimer"  href="'.URL.$ctrl.'/deletewil/'.$value['row_id'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
...
echo "</div>";	
?>
<div class="content"><img id="image" src="<?php echo URL;?>public/images/cim.jpg" ></div>
