<div class="sheader1l"><p id="dashboard"><?php echo "Gérer le Calendrier  des produits pharmaceutiques ";?></p></div><div class="sheader1r"><p id="dashboard"><?php html::NAV();?></p></div>
<div class="sheader2l">
...
<?php
		...
		echo'<table>';$colspan=15;
			...
			echo '<td align="left">'.View::nbrtostring('produit','id',$value['vaccin'],'produit').'</td>';
			echo '<td align="left">'.$value['jcal'].'</td>';
		...
		HTML::graphemois(30,340,'Calendrier Pharmaceutique  par mois Arret Au : ','','calendrier','date','',date('Y'),'','='.Session::get('structure')); 
		echo "</div>";
