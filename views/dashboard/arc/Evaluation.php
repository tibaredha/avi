...
<div class="sheader2l"><?php echo $this->msg; echo " Mortalité hospitalière : ";echo HTML::nbrtostring('structure','id',Session::get('structure'),'structure') ;?></div><div class="sheader2r">***</div>
<div class="contentl">
<?php 
